...
export default async function handler(req, res){
    try{
        const query = "select e.id, e.user_id, GROUP_CONCAT(act.type_name) as 'user_types', upp.profile_picture, upp.visibility as 'pic_visibility', u.first_name, u.last_name, e.edu_inst_id, ei.inst_name," +
            ...
            "JOIN degreetype d ON (e.degree_type_id = d.id) GROUP BY e.id order by e.record_date desc"
